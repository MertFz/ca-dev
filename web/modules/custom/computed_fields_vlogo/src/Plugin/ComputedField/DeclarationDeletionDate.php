 ...
 */
#[ComputedField(
  id: 'computed_field_declaration_deletion_date',
  label: new TranslatableMarkup('Declaration Deletion Date'),
  field_type: 'datetime',
  no_ui: FALSE,
  cardinality: 1,
)]
class DeclarationDeletionDate extends ComputedFieldBase {
  ...
  public function getFieldName(): ?string {
    return 'field_declaration_deletion_date';
  }
  ...
  public function getFieldLabel(): string {
    return 'Declaration Deletion Date';
  }
  ...
  public function computeValue(EntityInterface $host_entity, ComputedFieldDefinitionWithValuePluginInterface $computed_field_definition): array {
    ...
    $new_date->add(new \DateInterval('P7Y'));
